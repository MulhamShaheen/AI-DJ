...
Начата разработка API для микросервисной архитектуры приложение, возможно, в будущем данный интерфейс будет доступным для других пользовательских приложений. 

OpenAPI документация доступна на [Swagger](https://app.swaggerhub.com/apis/MulhamShaheen/ai-dj/1.0.0)
