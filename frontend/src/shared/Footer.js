        ...
        <footer className="bg-white rounded-lg shadow dark:bg-gray-900 m-4">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <a href="https://aidj.com/" className="flex items-center mb-4 sm:mb-0">
                ...
                <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://aidj.com/" class="hover:underline">AIDj™</a>. All Rights Reserved.</span>
            </div>
        </footer>
    );
}
